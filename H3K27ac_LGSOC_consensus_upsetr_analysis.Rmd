...
gr_voa_unique_lgsoc_k27ac_hg19 <- GenomicRanges::reduce(gr_voa_unique_lgsoc_k27ac_hg19, ignore.strand = TRUE, with.revmap=TRUE)
gr_voa_unique_lgsoc_k27ac_hg19
...
do (simon's newest method for) upsetr analysis
```{r}
